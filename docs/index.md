...
Widecoin is a powerful new peer-to-peer platform for the next generation of financial technology. The decentralized nature of the Widecoin network allows for highly resilient widecoin infrastructure, and the developer community needs reliable, open-source tools to implement widecoin apps and services. Litecore provides a reliable API for JavaScript apps that need to interface with Widecoin.
...
* [Peer to Peer Networking](https://github.com/widecoin-project/litecore-p2p)
