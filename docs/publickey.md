...
A PublicKey in Widecore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
```javascript
> var widecore = require('widecore');

// compressed public key starting with 0x03 (greater than midpoint of curve)
> var compressedPK = widecore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new widecore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = widecore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
