...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://widecore.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by widecore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a widecore Address object. The
 * same is true for `script`, which can be a string or a widecore Script.
 *
