...
describe('Address', function() {
  ...
  var str = 'WNurucC4ZtcTY5WkKzZwTLFzGrQyTv4mEJ';
  ...
  // livenet valid
  var PKHLivenet = [
    'WPaZzPcJjNGgQ7NsUrTvk4CiE9iTdiUJYm',
    'WQoyw9Awbpyur1CApeUr1Xur3DFmmEVbvL',
    'WT6EqpgNKmGHWiBQAL826K3Lf5YZ2gGVoy',
    'WTMEm3m1oSeHTdYCteigqRu5obiTxya52r',
    '    WTMEm3m1oSeHTdYCteigqRu5obiTxya52r   \t\n'
  ];

  // livenet p2sh
  var P2SHLivenet = [
    'EHHoBSgr5b3quBxQtf1XB5BDP9fhfnaoR4',
    'EHP35BuCdSzzjBs5rhuKN6zpwk2qfncBJZ',
    'ETgzhVcvS9zQ4pYMmHdtMP53usGGk6xsRU',
    'ETxK8siHVZQ3256LmqSDC9EpRi8n4cHfb8',
    '\t \nETxK8siHVZQ3256LmqSDC9EpRi8n4cHfb8 \r'
  ];

  // testnet p2sh
  var P2SHTestnet = [
    'TEFHJvgEk97uNfbTYSdecCc3a5VLgRjQV4',
    'THykv9x11DXBSE8JNgodq7zHFHX7cbf6cM',
    'TKZuhVQX4wL3mJonHJ8WPpYu5RYZFvtcN3',
    'TLX49HfTKP1JkZ2LanpwuyZYxUD4hr78dP'
  ];
  ...
  describe('validation', function() {
    ...
    it('getValidationError detects network mismatchs', function() {
      var error = Address.getValidationError('WTi4PhWNPT5hhvtRzufTnpRby2oo6Y5rpP', 'testnet');
      should.exist(error);
    });

    it('isValid returns true on a valid address', function() {
      var valid = Address.isValid('WTi4PhWNPT5hhvtRzufTnpRby2oo6Y5rpP', 'livenet');
      valid.should.equal(true);
    });

    it('isValid returns false on network mismatch', function() {
      var valid = Address.isValid('WTi4PhWNPT5hhvtRzufTnpRby2oo6Y5rpP', 'testnet');
    ...
    it('addresses with whitespace are validated correctly', function() {
      var ws = '  \r \t    \n WVTbJcQUy2jJgPJB6uZaX2jjhnGrG8Hj3R \t \n            \r';
      var error = Address.getValidationError(ws);
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('WVTbJcQUy2jJgPJB6uZaX2jjhnGrG8Hj3R');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('WWvnHc9NrzTPAGVvQmUzsVur4n6VFSrusm');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('WXYhy1s6kPGkZj6k1tqu9T39ZPVQLhhhdp');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('WXYhy1s6kPGkZj6k1tqu9T39ZPVQLhhhdp');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('WZNHFSeUCGxYQmzPmck9eeWpzEY4LTsbdA');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('WZNHFSeUCGxYQmzPmck9eeWpzEY4LTsbdA');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('Wac2X16yttTtgYc5pZXmSk2aY2D5YR7LHh');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('Wac2X16yttTtgYc5pZXmSk2aY2D5YR7LHh');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'WeWY2PPBx7yXVEisdXH4fHHi37MYGM2ZC7';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = 'Ed1rfgKmAGd8Mh4yFcZiW3yRQQhUt2DKMb';
  ...
  describe('#toBuffer', function() {
    ...
    it('3c3fa3d4adcaf8f52d5b1843975e122548269937 corresponds to hash Wehos1cb4SX4nHi1dQwqKEMipew5q9nna1', function() {
      var address = new Address(str);
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('WexuDEAMp6PXEtAiieBFy8ZseWHnpFeThp');
    ...
    it('works on testnet also', function() {
      ...
      address.toString().should.equal('TS5aoseo7Sw7YAgYC5c5n62p9ZANVaQpG8');
    });
